    ...
    if (quotedMessage) {
      ...
      if (args.length < 2) {
        return sock.sendMessage(chatId, {
          text: `🌐 *TRANSLATOR*\n\nUsage:\n1. Reply to a message with: ${getPrimaryPrefix()}translate <lang> or ${getPrimaryPrefix()}trt <lang>\n2. Or type: ${getPrimaryPrefix()}translate <text> <lang> or ${getPrimaryPrefix()}trt <text> <lang>\n\nExample:\n${getPrimaryPrefix()}translate hello fr\n${getPrimaryPrefix()}trt hello fr\n\nLanguage codes:\nfr - French\nes - Spanish\nde - German\nit - Italian\npt - Portuguese\nru - Russian\nja - Japanese\nko - Korean\nzh - Chinese\nar - Arabic\nhi - Hindi`,
          quoted: message,
        });
      }
